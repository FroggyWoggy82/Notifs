...
async function fixRobertNextOccurrence() {
    try {
        console.log('Fixing Robert task next occurrence to display as 6/5/2026...\n');
        
        // The due date 2025-06-06T00:00:00.000Z displays as 6/5/2025 correctly
        // So the next occurrence should be 2026-06-06T00:00:00.000Z to display as 6/5/2026
        ...
        console.log('\n='.repeat(60));
        console.log('Robert task next occurrence fix complete!');
        console.log('='.repeat(60));

    } catch (err) {
        console.error('Error fixing Robert task next occurrence:', err);
    } finally {
        process.exit();
    }
}

fixRobertNextOccurrence();
