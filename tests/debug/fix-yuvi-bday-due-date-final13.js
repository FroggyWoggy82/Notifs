// Script to fix Yuvi's Bday due date and next occurrence date
...
async function fixYuviBdayDueDate() {
    ...
    try {
        ...
        for (const task of result.rows) {
            ...
            // Set the due date to 2025-05-13 (which should display as 5/14/2025 due to the timezone issue)
            const formattedDueDate = '2025-05-13';
            ...
            // Set the next occurrence date to 2026-05-13 (which should display as 5/14/2026 due to the timezone issue)
            const formattedNextOccurrenceDate = '2026-05-13';
        ...
        console.log('\nYuvi\'s Bday due date and next occurrence date have been updated successfully!');

    } catch (err) {
        console.error('Error fixing Yuvi\'s Bday due date and next occurrence date:', err);
    } finally {
        client.release();
        pool.end();
    }
