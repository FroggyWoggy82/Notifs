/**
 * Direct Add Ingredient Fix
 * Directly fixes the Add Ingredient button in the Create New Recipe section
 */

(function() {
    console.log('[Direct Add Ingredient Fix] Initializing');
    ...
    function createNewIngredientRow() {
        ...
        if (!initialized) {
            console.log('[Direct Add Ingredient Fix] Creating new ingredient row');
        }
    ...
    function addNewIngredientRow() {
        // Only log once per session
        if (!initialized) {
            console.log('[Direct Add Ingredient Fix] Adding new ingredient row');
        }
    ...
    function addEventListenersToIngredientItem(ingredientItem) {
        // Only log once per session
        if (!initialized) {
            console.log('[Direct Add Ingredient Fix] Adding event listeners to ingredient item');
        }
    ...
    function initializeIngredientItems() {
        // Only log once per session
        if (!initialized) {
            console.log('[Direct Add Ingredient Fix] Initializing ingredient items');
            initialized = true;
        }
    ...
    console.log('[Direct Add Ingredient Fix] Initialized');
})();
