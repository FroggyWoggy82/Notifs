...
// Also create a button to run the diagnostic on demand
const diagnosticButton = document.createElement('button');
diagnosticButton.textContent = 'Run Icon Diagnostic';
diagnosticButton.style.position = 'fixed';
diagnosticButton.style.top = '10px';
diagnosticButton.style.right = '10px';
diagnosticButton.style.zIndex = '9999';
diagnosticButton.style.padding = '5px 10px';
diagnosticButton.style.backgroundColor = '#f00';
...
diagnosticButton.addEventListener('click', diagnoseIcons);
