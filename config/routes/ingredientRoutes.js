/**
 * Ingredient Routes
 * Handles API endpoints for ingredient operations
 */
 ...
 * @route GET /api/ingredients/unique
 * @returns {Array} 200 - Array of unique ingredients
 */
 ...
 * @param {string} id.path.required - Ingredient ID
 * @returns {Object} 200 - Ingredient details
 */
