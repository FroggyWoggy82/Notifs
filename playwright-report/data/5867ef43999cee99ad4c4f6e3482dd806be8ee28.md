...
Call log:
  ...
  - waiting for locator('.task-item:has-text("Grocery List")').first()
    5 × locator resolved to <div data-task-id="623" class="task-item complete ">…</div>
      - unexpected value "hidden"
    4 × locator resolved to <div data-task-id="623" data-grocery-list="true" class="task-item complete has-subtasks">…</div>
      - unexpected value "hidden"
