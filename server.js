...
const unifiedPhotoUploadRoutes = require('./routes/unified-photo-upload'); // NEW: Unified photo upload route
...
app.use('/api/unified-photos', unifiedPhotoUploadRoutes); // NEW: Unified photo upload route
